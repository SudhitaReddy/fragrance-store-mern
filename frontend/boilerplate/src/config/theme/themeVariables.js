...
// Function to update CSS custom properties for dynamic theme colors
const updateCSSVariables = (isDarkMode = false) => {
  ...
  root.style.setProperty('--dark-text-color', darkColor);
  root.style.setProperty('--light-background-color', isDarkMode ? '#2a2a2a' : '#f5f5f5');
  root.style.setProperty('--border-color-normal', isDarkMode ? '#494B55' : '#d9d9d9');
};

export { theme, themeColor, updateCSSVariables };
