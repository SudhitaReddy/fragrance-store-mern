...
import UilCalender from '@iconscout/react-unicons/icons/uil-calendar';
...
function Calendars() {
  ...
  const onSelectEvent = (selectedData) => {
    setState({
      ...
      selectedEvent: {
        ...selectedData,
        start: new Date(selectedData.start),
        end: new Date(selectedData.end),
      },
    });
  };
                  ...
                  <div className="ninjadash-event-details">
                    <ul>
                      ...
                      <li>
                        ...
                        <span className="ninjadash-event-text">
                          <strong>
                            {selectedEvent && selectedEvent.start ? moment(selectedEvent.start).format('LT') : 'N/A'} -{' '}
                            {selectedEvent && selectedEvent.end ? moment(selectedEvent.end).format('LT') : 'N/A'}
                          </strong>
                        </span>
                      </li>
