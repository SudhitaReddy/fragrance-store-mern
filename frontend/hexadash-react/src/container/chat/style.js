...
const Content = Styled.div`
  ...
  .chat-link-signle{
    ...
    &:before{
      ...
      right: -10px;
      left: -10px;
      box-shadow: 0 15px 50px ${({ theme }) => theme[theme.mainContent]['light-text']}20;
      border-radius: 4px;
      visibility: hidden;
      opacity: 0;
      transition: 0.3s ease;
...
const SingleChatWrapper = Styled.div`
  &.group-chat{
    .chatbox-reply-form{
      input{
        ...
        box-shadow: 0 5px 30px ${({ theme }) => theme[theme.mainContent]['extra-light-text']}15;
      }
    }
  }
  &.ninjadash-chat-home{
  ...
  .ant-card-head{
    ...
    box-shadow: 0 10px 20px ${({ theme }) => theme[theme.mainContent]['extra-light-text']}15;
    border: 0 none;
    .ant-card-extra{
    ...
    .ant-card-head-title{
      ...
      p{
        ...
        font-weight: 400;
        margin-bottom: 0;
        color: color: ${({ theme }) => theme[theme.mainContent]['gray-light-text']};
      }
    }
  }
  ...
  .group-chat-header{
    ...
    .members{
      ...
      .add-more{
        border: 1px dashed ${({ theme }) => theme[theme.mainContent]['border-color-deep']};
        span{
          line-height: .4;
        }
      }
  ...
  .atbd-chatbox{
    ...
    .atbd-chatbox__single{
      ...
      .left{
        ...
        .message-box{
          color: ${({ theme }) => theme[theme.mainContent]['chat-reply-text']};
          background: ${({ theme }) => theme[theme.mainContent]['chat-reply-bg']};
          word-wrap: break-word;
          word-break: break-word;
          overflow-wrap: break-word;
          white-space: normal;
      ...
      .right{
        ...
        .message-box{
          ...
          background: ${({ theme }) => theme[theme.mainContent]['chat-bg']};
          color: ${({ theme }) => theme[theme.mainContent]['dark-text']};
          word-wrap: break-word;
          word-break: break-word;
          overflow-wrap: break-word;
...
const ChatSidebar = Styled.div`
  ...
  .custom-scrollbar{
    ...
    .ninjadash-track-vertical{
      ...
      border-radius: 3px;
      >div{
        background: ${({ theme }) => theme[theme.mainContent]['scroll-bg']} !important;
      }
    }
  }
