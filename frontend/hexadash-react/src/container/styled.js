...
const Main = Styled.div`
    ...
    .ant-progress .ant-progress-outer {
        ${({ theme }) => (!theme.rtl ? 'margin-right' : 'margin-left')}: 12px !important;
...
const BasicFormWrapper = Styled.div`
    ...
    .ant-form-item-control-input{
        ...
        /* Button Hover Colors for Theme - Force Override */
        .ant-btn-primary:hover,
        .ant-btn-primary:focus,
        .ant-btn-primary:active {
            background-color: #6726A8 !important;
            border-color: #6726A8 !important;
            color: #fff !important;
            box-shadow: 0 0 0 2px rgba(103, 38, 168, 0.2) !important;
        }
        .ant-btn-white:hover,
        .ant-btn-white:focus,
        ...
        .project-modal-footer .ant-btn-primary:hover,
        .project-modal-footer .ant-btn-primary:focus,
        .project-modal-footer .ant-btn-primary:active {
            background-color: #6726A8 !important;
            border-color: #6726A8 !important;
            color: #fff !important;
            box-shadow: 0 0 0 2px rgba(103, 38, 168, 0.2) !important;
        }
        .project-modal-footer .ant-btn-white:hover,
        .project-modal-footer .ant-btn-white:focus,
        .project-modal-footer .ant-btn-white:active {
            background-color: #f5f5f5 !important;
            border-color: #d9d9d9 !important;
            color: #090e30 !important;
        }
        /* Additional button hover fixes */
        ...
        button.ant-btn-white:hover,
        button.ant-btn-white:focus,
        button.ant-btn-white:active {
            background-color: #f5f5f5 !important;
            border-color: #d9d9d9 !important;
            color: #090e30 !important;
        }
        ...
        .ant-form-item-control-input{
            ...
            textarea{
                ...
                &:focus{
                    ...
                    box-shadow: 0 0 0 2px rgba(130, 49, 211, 0.1) !important;
