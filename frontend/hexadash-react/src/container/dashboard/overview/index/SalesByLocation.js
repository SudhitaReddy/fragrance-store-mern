...
const SaleByLocation = React.memo(() => {
  ...
  if (salesLocation !== null)
    salesLocation[locationTab].forEach((item, key) => {
          ...
          <SaleLocationMap>
            <div>
              ...
              <div className="controls">
                <button aria-label="ZoomIn" type="button" onClick={handleZoomIn}>
                  <svg
                ...
                <button aria-label="ZoomOut" type="button" onClick={handleZoomOut}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
